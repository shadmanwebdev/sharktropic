    ...
    <div class='main'>
        ...
        <div class='admin-form-outer'>
            ...
            <style>
                ...
                .subscribers .c-row .item img.arrow-up {
                    margin-top: -3px;
                    margin-right: 2px;
                }
                ...
                <div class='subscribers'>
                    <div class="content-main">
                        <div class="head">
                            ...
                            <span class="btns">
                                <span class='btn admin-btn-2' onclick='create_donation_popup()'>
                                    + Create Donations
                                </span>
                            </span>
                        </div>
...
<script defer>
    function create_donation_popup() {
        closePopup();

        fetch('./create-donation-popup.php?type=donation')
        .then(response => response.text())
        .then(response => {
            // console.log(response);
            // setTimeout(function() {
    ...
    function edit_donation_popup(donation_id) {
        closePopup();

        fetch('./edit-donation-popup.php?type=donation&donation_id=' + donation_id)
        .then(response => response.text())
        .then(response => {
            // console.log(response);
            // setTimeout(function() {
