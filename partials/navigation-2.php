...
<!-- Header overly cart_quantity .btn -->
<style>
    /*--------------------------------------------------------------
    # Header  border
    --------------------------------------------------------------*/
    #header {
        ...
        /* background: linear-gradient(#f8f9fb, #f5f7fa); */
...
<header id="header" class="<?= $fixedTop; ?>">
    <div class="container" style=''>
        ...
        <div class="logo float-left">
            <a href="./">
                <!-- Logo -->
                <img src="assets/logo-6.png?v=5" alt="" class="img-fluid">
            </a>
        </div>
        <div class="logo logo-dark float-left">
            <a href="./">
        ...
        <div class='menu-items-flex'>
            ...
            <nav class="nav-menu float-right d-none d-lg-block">
                <div class="logo float-left">
                    <a href="./">
                        <!-- Logo -->
                        <img src="assets/logo.svg?v=1" alt="" class="img-fluid">
                    </a>
                </div>
                <ul>
                ...
                ?>
                        <li class="n-item"><a href="./shop">Shop</a></li>
                        <li class="n-item"><a href="./about">About</a></li>
                        <li class="n-item"><a href="./collections">Collections</a></li>
                        <li class="n-item"><a href="./news">News</a></li>
                        <li class="n-item"><a href="./mailing-list">Mailing list</a></li>
